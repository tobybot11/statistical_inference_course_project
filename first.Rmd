...
```
The Sample Mean is **`r OverallSampleMean`**. The Theoretical Mean is **`r TheoreticalMean`**.

**Analysis** : Close Enough! Sample Mean is very close (**`r TheoreticalMean-OverallSampleMean`**) to Theoretical Mean.
...
The Sample Standard Deviation is **`r OverallSampleStandardDeviation`**. The Theoretical Standard deviation is **`r TheoreticalStandardDeviation`**.

**Analysis** : Close Enough! Sample Standard Deviation is very close (**`r OverallSampleStandardDeviation - TheoreticalStandardDeviation`**) to the Theoretical Standard Deviation.
...
```
The Sample Variance is **`r SampleVariance`**. The Expected Variance is **`r ExpectedVariance`**.

**Analysis** : Close Enough! Sample Variance is very close (**`r SampleVariance - ExpectedVariance`**) to the Expected Variance.

## Distribution
Via figures and text, explain how one can tell the distribution is approximately normal.

```{r, echo=FALSE, fig.cap="**Distribution at 1000 samples of the means of 40 exponentials, overlayed with the normal distribution with the expected mean and standard deviation.**" }
library(ggplot2)
...
```{r, echo=FALSE, fig.cap="**Distribution of 1000 exponentials.**" }
...
```{r, echo=FALSE, fig.cap="**Distribution at 10000 samples of the means of 40 exponentials overlayed by the normal distribution.**" }
Simulations = 10000
SampleMeans <- sapply(1:Simulations, function(x) { mean(rexp(Exponentials, Lambda)) } )
